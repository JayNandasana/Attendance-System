...
def qr():
    ...
    def ok():
        ...
        if Name=='Select Faculty' or Subject=='Select Subject' or Class=='Select Class':
            b = ttk.Label(qr, text="Enter full details",font=("Helvetica", 11))
            b.config(background='LightBlue2',foreground='red')
            b.grid(columnspan=2,row=8,  padx=7, pady=7)
        else:
            main()
    ...
    def main():
        ...
        while(cap.isOpened()):
            ...
            for i in data: 
                ...
                # Change QR Code pattern from hear
                cnf=r"20SOECE110[0-9][0-9]"
                ...
                if not(re.fullmatch(cnf,enrollment)):
                    ...
                    j.setProperty("voice",voices[1].id)
    ...
    b= Label(qr, text="QR  Code  Based  Attendance  System",font=('Jokerman 18'))
    ...
    # subject
    subject = ttk.Label(qr, text="Subject  :",font=("Sylfaen", 14))
    ...
    x.config(bg="DeepSkyBlue2",font=("Sylfaen", 13))
    x['menu'].config(bg="LightSteelBlue2",font=("Sylfaen", 13))
    x.grid(column=1, row=2,  padx=50, sticky=tk.EW)

    # username
    name = ttk.Label(qr, text="Faculty Name  :",font=("Sylfaen", 14))
    ...
    # class
    Class = ttk.Label(qr, text="Class  :",font=("Sylfaen", 14))
    ...
    date = ttk.Label(qr, text="Date  :",font=("Sylfaen", 14))
    date.config(background='LightBlue2')
    date.grid(column=0, row=5,  padx=5, pady=20)
    e4 = DateEntry(qr, width=12, year=y, month=m, day=d,background='deep sky blue', borderwidth=2,font=("Sylfaen", 13),date_pattern="dd/mm/yy")
    e4.grid(column=1, row=5,  padx=50, sticky=tk.EW)

    x=ttk.Label(qr, text="",font=("Helvetica", 15))
    x.config(background='LightBlue2')
    x.grid()
    # Take Attendance button
    button = tk.Button(qr, text="Take  Attendance",bg='DeepSkyBlue2',command=ok,font=("Jokerman", 12))
    button.grid(columnspan=2, row=7, padx=5, pady=5)
...
root.geometry("580x280")    # GUI window size.
...
Label(root, text="Wellcome  to  Smart  Attendance  Application", font=('Jokerman 18 '), fg="blue",bg='LightBlue2').pack(pady=10)  
Label(root, text="", font=('Aerial 15'), fg="blue",bg='LightBlue2').pack(pady=10)  
Label(root, text="", font=('Aerial 15'), fg="blue",bg='LightBlue2').pack(pady=10)  
b1=Button(root, text="Attendance  by  QR  Code",font=("Jokerman", 12), command= qr,bg='DeepSkyBlue2').pack(padx=5, pady=5,ipadx=5)    
b2=Button(root, text="Attendance  by  Face",font=("Jokerman", 12), command= face,bg='DeepSkyBlue2').pack(padx=5, pady=5,ipadx=24)   
